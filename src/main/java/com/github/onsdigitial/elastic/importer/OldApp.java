...
// */
//public class OldApp implements AutoCloseable {
//
...
//                    }
//                    if (page != null) {
//                        LOGGER.info("Got page with uri: " + page.getUri());
//                        if (!this.pages.containsKey(type)) {
//                            this.pages.put(type, new ArrayList<>());
//                        }
...
//            }
//            this.searchClient.createIndex(index, DefaultDocumentTypes.DOCUMENT, settings, mapping);
...
//            this.searchClient.bulk(index, DefaultDocumentTypes.DOCUMENT, this.pages.get(index));
//        }
//    }
//
